        ...
        <div className={deepness > 0 ? 'gt-input-container gt-space' : 'gt-input-container'} key={index}>
            ...
            <div className='gt-attributes-container'>
                <div className='gt-attributes'>
                    ...
                    {!task.task_id ? (
                        <textarea type='text' value={task.title} onChange={(e) => handleTitleChange(task, e.value)} />
                    ) : (
                ...
                <div className='gt-attributes'>
                    ...
                    {!task.task_id ? (
                        <textarea value={task.description} onChange={(e) => handleDescriptionChange(task, e.value)} />
                    ) : (
            ...
            <div className='gt-action-buttons'>
                ...
                <button className='generate-button' onClick={() => generateSubtaskPrepare(task)}>
                    Generate Subtasks
                </button>
            </div>
