        ...
        <form className="auth-form" onSubmit={handleSubmit}>
          {keyState === "signup" ? (
            <div className="form-group">
              ...
              {formData.username.trim() !== "" && (
                <div
                  className={`auth-error ${usernameError ? "" : "auth-valid"}`}
                  style={{
                    textShadow:
                      usernameError && isVibrating ? "0 0 10px red" : "none",
                    animation:
                      usernameError && isVibrating
                        ? "shake 0.5s linear infinite"
                        : "none",
                  }}
                >
                  {usernameError ? usernameError : "Username available"}
                </div>
              )}
            </div>
          ) : null}
          {keyState === "signup" ? (
            <div className="form-group">
              ...
              {formData.email.trim() !== "" && (
                <div
                  className={`auth-error ${emailError ? "" : "auth-valid"}`}
                  style={{
                    textShadow:
                      emailError && isVibrating ? "0 0 10px red" : "none",
                    animation:
                      emailError && isVibrating
                        ? "shake 0.5s linear infinite"
                        : "none",
                  }}
                >
