...
const noteStrickyIcon = <FontAwesomeIcon icon={faNoteSticky} />;
            ...
            <>
                ...
                >
                    ...
                    {task && task.description && (
                        <div>
                            <span className="icon icon-margin">{noteStrickyIcon}</span>
                            <small>{"See more"}</small>
                        </div>
                    )}
                    {task && task.due_date && (
                        <div>
                            <span className="icon icon-margin">{stopwatchIcon}</span>
