...
const Board = () => {
    ...
    const reloadCodeReviewOrDocumentation = async () => {
        const codeReviewOrDocumentationResponse = await axios.get(`/AGI/CodeReviewOrDocumentation/boards/${board_id}`, {
            headers: {
                Authorization: `Bearer ${token}`,
            },
        });
                        ...
                        <div className='agi-submenu' onMouseLeave={() => setIsAGIOpen(false)}>
                            ...
                            <ul className='agi-menu'>
                                ...
                                {codeReviewOrDocumentations.map((element, index) => (
                                    <ul className='code-review-or-documentation-container'>
                                        <li
                                            key={index}
                                            className='code-review-or-documentation-title'
