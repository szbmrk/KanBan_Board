...
const Popup = (
    ...
    useEffect(() => {
        ...
        setEditedDescription(task.description);
        handleGetBoardTags();
        setShowTagEditorPopup(openTagsOnStart);
    }, [task]);
    ...
    const getNotMembers = async () => {
        try {
            ...
            window.log(response.data.users);
                        ...
                        <div className="description-container">
                            {showEditDescription ? (
                                <>
                                    ...
                                    />
                                    <span
                                        className="description-edit-action-button"
                                        id="check-button"
